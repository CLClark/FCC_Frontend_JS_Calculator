...
class CalcApp extends React.Component {
  ...
  updateCurNum(appendage) {
    ...
    switch (this.state.cleared) {
      case false:
        //existing display value already, concat
  ...
  operAdd(opName) {
    ...
    if (currStack.length > 0) {
      ...
      currStack[currStack.length - 1] = lastOp; //if opName not "equals", reset current value
  ...
  procEquals() {
    ...
    switch (this.state.cleared) {
      ...
      default:
        //stack has existing object, update last's operation					
        let stackToProc = this.operAdd("equals"); //pass stack into processor...

        let processedStack = this.procStack(stackToProc); //return value as firstValue in new stack, object of length 1				
...
class Button extends React.Component {
  ...
  render() {
    ...
    return React.createElement("div", {
      ...
      updateDecimal: this.props.updateDecimal
    }), React.createElement("div", {
      style: blankStyle
...
class Decimal extends React.Component {
  ...
  render() {
    return React.createElement("div", {
      className: "calc-button",
      style: this.props.styleIn,
      onClick: this.props.updateDecimal
    }, React.createElement("div", {
      style: buttonText
    }, "."));
  }
